...
const Register: React.FC = () => {
  ...
  const labelStyles = "block text-sm font-medium text-neutral-600 dark:text-neutral-400 mb-1";
  ...
  if (showSuccessMessage) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300">
        <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-neutral-800 rounded-xl shadow-lg text-center">
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-700 dark:text-neutral-300 py-12">
      <div className="text-center mb-8">
            <h1 className="text-5xl font-bold text-primary-500">IT Hub</h1>
            <p className="mt-2 text-lg text-neutral-500 dark:text-neutral-400">{t('enterprise it ops management')}</p>
        </div>
        <div className="w-full max-w-md p-8 space-y-6 bg-white dark:bg-neutral-800 rounded-xl shadow-lg">
            ...
            <div className="flex bg-neutral-200/70 dark:bg-neutral-700/50 p-1 rounded-lg">
                <Link
                to="/login"
                className="flex-1 text-center py-2.5 rounded-md text-neutral-500 dark:text-neutral-400 hover:bg-neutral-300/50 dark:hover:bg-neutral-700/80 font-semibold text-sm"
                >
                {t('sign in')}
                </Link>
                <Link
                to="/register"
                className="flex-1 text-center py-2.5 rounded-md bg-white dark:bg-neutral-900 text-neutral-900 dark:text-white font-semibold text-sm shadow-md"
                >
                {t('sign up')}
                </Link>
            </div>
