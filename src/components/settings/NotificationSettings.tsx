  ...
  return (
    <label htmlFor={id} className="flex items-center cursor-pointer">
      <div className="relative">
        ...
        />
        <div className={`block w-12 h-6 rounded-full transition-colors duration-200 ${enabled ? 'bg-primary-600' : 'bg-neutral-300 dark:bg-neutral-600'}`}></div>
        <div className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full shadow-sm transition-all duration-200 ${enabled ? 'translate-x-6' : ''}`}></div>
      </div>
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div className="p-4 border border-neutral-200 rounded-lg dark:border-neutral-700">
