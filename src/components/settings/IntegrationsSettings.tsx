...
const availableServices = [
    ...
    { id: 'zendesk', name: 'Zendesk', logo: <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Zendesk_logo.svg" alt="Zendesk" className="w-12 h-12" referrerPolicy="no-referrer" />, descKey: 'integration zendesk desc', url: 'https://www.zendesk.com' },
    { id: 'zapier', name: 'Zapier', logo: <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/zapier.svg" alt="Zapier" className="w-12 h-12" referrerPolicy="no-referrer" />, descKey: 'integration zapier desc', url: 'https://zapier.com' },
    ...
    { id: 'entraid', name: 'Microsoft Entra ID', logo: <img src="https://commons.wikimedia.org/wiki/Special:FilePath/Microsoft_Entra_ID_color_icon.svg" alt="Microsoft Entra ID" className="w-12 h-12" referrerPolicy="no-referrer" />, descKey: 'integration entraid desc', url: 'https://entra.microsoft.com' },
