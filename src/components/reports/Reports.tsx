...
const CurrencyUtils = {
    format: (value: number) => {
        return new Intl.NumberFormat(navigator.language, { style: 'currency', currency: 'EUR', maximumFractionDigits: 0 }).format(value);
    }
};
...
const ChartWrapper: React.FC<{ title: string; children: React.ReactNode; hasData: boolean; height?: number; subtitle?: string }> = ({ title, children, hasData, height = 350, subtitle }) => (
  <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-neutral-200/50 dark:border-neutral-700/50 flex flex-col transition-all hover:border-primary-500/30">
            ...
            {activeTab === 'assets' && (
                <>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-2xl shadow-sm border border-neutral-200/50 dark:border-neutral-700/50 flex flex-col h-[350px] min-h-[350px]">
            ...
            {activeTab === 'users' && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="bg-white/70 dark:bg-neutral-800/70 backdrop-blur-sm p-6 rounded-2xl border border-neutral-200/50 dark:border-neutral-700/50 flex items-center justify-between h-[165px]">
                             <div>
