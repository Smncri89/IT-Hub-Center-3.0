...
const LandingPage: React.FC = () => {
  ...
  const benefits = [
    ...
    { icon: Shield, title: 'Enterprise-grade security', desc: 'AES-256 encryption, RLS, RBAC, 2FA, CSP headers. GDPR, NIS2, ISO 27001 & SOC 2 compliant infrastructure.' },
  ];
  ...
  const faqs = [
    ...
    { q: 'Where is my data stored?', a: 'EU data centers via Supabase (SOC 2 Type II, ISO 27001 certified). Encrypted at rest (AES-256) and in transit (TLS 1.3). Row-level security, RBAC, 2FA, and CSP headers. Fully GDPR and NIS2 compliant.' },
    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 overflow-x-hidden antialiased font-sans">
      ...
      <section className="relative pt-32 sm:pt-40 lg:pt-48 pb-20 sm:pb-32 px-4 sm:px-6 lg:px-8">
        ...
        <motion.div style={{ opacity: heroOpacity, scale: heroScale }} className="max-w-4xl mx-auto text-center">
          ...
          >
            Free for 30 days &middot; No credit card &middot; GDPR &amp; NIS2 compliant &middot; ISO 27001 &middot; EU hosted
          </motion.p>
        </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            <div className="md:col-span-2">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-neutral-400 dark:text-neutral-500">
                <span>GDPR</span><span>&middot;</span>
                <span>NIS2</span><span>&middot;</span>
                <span>ISO 27001</span><span>&middot;</span>
                <span>SOC 2</span><span>&middot;</span>
                <span>OWASP</span><span>&middot;</span>
                <span>AES-256</span><span>&middot;</span>
                <span>TLS 1.3</span><span>&middot;</span>
                <span>RBAC</span><span>&middot;</span>
                <span>2FA</span><span>&middot;</span>
