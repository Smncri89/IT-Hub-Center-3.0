    ...
    return (
        <div style={{ position: 'relative' }}>
            <button
                ...
                className="relative p-2 rounded-full hover:bg-neutral-100 dark:hover:bg-neutral-700 text-neutral-600 dark:text-neutral-300 transition-all active:scale-95"
            ...
            >
                ...
                {unreadCount > 0 && (
                    <span className="absolute top-1 right-1 flex h-4 w-4">
                        ...
                        <span className="relative inline-flex rounded-full h-4 w-4 bg-red-500 text-white text-[10px] font-bold items-center justify-center ring-2 ring-white dark:ring-neutral-900">{unreadCount}</span>
                    </span>
                )}
            </button>
            {isOpen && (
