...
export const ASSET_IMAGE_LIBRARY: Record<string, { label: string, url: string, keywords: string[] }> = {
    ...
    'dell_latitude': { label: 'Dell Latitude', url: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', keywords: ['dell', 'latitude', '3550', '3540', '3520', '3510', '5540', '5530', '5520', '5510', '7440', '7430', '7420', '7340', 'latitude 3', 'latitude 5', 'latitude 7'] },
    'dell_inspiron': { label: 'Dell Inspiron', url: 'https://images.unsplash.com/photo-1593642632823-8f78536788c6?auto=format&fit=crop&w=200&q=80', keywords: ['dell', 'inspiron', '14', '15', '16', '3520', '5620'] },
    'dell_precision': { label: 'Dell Precision', url: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', keywords: ['dell', 'precision', '3580', '5570', '7770', 'workstation'] },
    'dell_optiplex': { label: 'Dell OptiPlex', url: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', keywords: ['dell', 'optiplex', '7010', '7020', '5000', 'micro', 'sff'] },
    'dell_vostro': { label: 'Dell Vostro', url: 'https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?auto=format&fit=crop&w=200&q=80', keywords: ['dell', 'vostro', '3520', '5620', '3510'] },
    ...
    'thinkpad': { label: 'Lenovo ThinkPad', url: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', keywords: ['thinkpad', 'l14', 'l15', 't14', 't16', 'e14', 'e15', 'p14s', 'p16s'] },
    'lenovo_ideapad': { label: 'Lenovo IdeaPad', url: 'https://images.unsplash.com/photo-1593642702821-c8da6771f0c6?auto=format&fit=crop&w=200&q=80', keywords: ['lenovo', 'ideapad', 'slim', '3', '5', 'flex'] },
    'lenovo_thinkbook': { label: 'Lenovo ThinkBook', url: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=200&q=80', keywords: ['lenovo', 'thinkbook', '14', '15', '16'] },
    ...
    'hp_elitebook': { label: 'HP EliteBook', url: 'https://images.unsplash.com/photo-1544731612-de7f96afe55f?auto=format&fit=crop&w=200&q=80', keywords: ['hp', 'elitebook', '840', '850', '860', '640', '650', 'g9', 'g10'] },
    'hp_probook': { label: 'HP ProBook', url: 'https://images.unsplash.com/photo-1544731612-de7f96afe55f?auto=format&fit=crop&w=200&q=80', keywords: ['hp', 'probook', '440', '450', '640', '650'] },
    'hp_zbook': { label: 'HP ZBook', url: 'https://images.unsplash.com/photo-1587202372775-e229f172b9d7?auto=format&fit=crop&w=200&q=80', keywords: ['hp', 'zbook', 'fury', 'firefly', 'power', 'studio'] },
