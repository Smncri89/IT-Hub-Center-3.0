...
export const ICONS = {
  ...
  billing: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 002.25-2.25V6.75A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25v10.5A2.25 2.25 0 004.5 19.5z" /></svg>,
...
export const PLAN_LIMITS: Record<string, { maxUsers: number; maxAssets: number; price: number; label: string }> = {
    free: { maxUsers: 5, maxAssets: 50, price: 0, label: 'Starter' },
    pro: { maxUsers: 999999, maxAssets: 999999, price: 29, label: 'Pro' },
    enterprise: { maxUsers: 999999, maxAssets: 999999, price: 0, label: 'Enterprise' },
};